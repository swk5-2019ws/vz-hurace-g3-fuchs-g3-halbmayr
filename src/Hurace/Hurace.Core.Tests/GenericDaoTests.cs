...
namespace Hurace.Core.Tests
{
    public class GenericDaoTests
    {
        ...
        [InlineData(typeof(Domain.RaceData), 2965)]
        ...
        [InlineData(typeof(Domain.StartList), 72)]
        [InlineData(typeof(Domain.StartPosition), 2965)]
        [InlineData(typeof(Domain.TimeMeasurement), 12251)]
