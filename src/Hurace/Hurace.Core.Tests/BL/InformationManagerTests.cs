...
namespace Hurace.Core.Tests.BL
{
    ...
    //        A.CallTo(() => skierDaoFake.GetByIdAsync(A<int>.That.IsEqualTo(1)))
    //            .ReturnsLazily(() => skierEntities.First(s => s.Id == 1));
    //        A.CallTo(() => skierDaoFake.GetByIdAsync(A<int>.That.IsEqualTo(2)))
    //            .ReturnsLazily(() => skierEntities.First(s => s.Id == 2));
    //        A.CallTo(() => skierDaoFake.GetByIdAsync(A<int>.That.IsEqualTo(3)))
    //            .ReturnsLazily(() => skierEntities.First(s => s.Id == 3));
    ...
    //        await informationManager.UpdateRace(new Domain.Race()
    //        {
    //            Date = DateTime.Now.AddDays(-15),
    //            Description = "New Fancy Description",
    //            Id = 0,
    //            NumberOfSensors = 5,
    //            RaceType = new Domain.Associated<Domain.RaceType>()
    //            {
    //                Reference = new Domain.RaceType()
    //                {
    //                    Id = 0,
    //                    Label = "RiesentorLauf"
    //                }
    //            },
    //            Venue = new Domain.Associated<Domain.Venue>()
    //            {
    //                Reference = new Domain.Venue()
    //                {
    //                    Id = 1,
    //                    Country = new Domain.Associated<Domain.Country>()
    //                    {
    //                        ForeignKey = 3
    //                    },
    //                    Name = "Levi"
    //                }
    //            },
    //            FirstStartList = new List<Domain.Associated<Domain.StartPosition>>()
    //            {
    //                new Domain.Associated<Domain.StartPosition>()
    //                {
    //                    Reference = new Domain.StartPosition()
    //                    {
    //                        Position = 1,
    //                        Skier = new Domain.Associated<Domain.Skier>()
    //                        {
    //                            Reference = new Domain.Skier()
    //                            {
    //                                Id = 2,
    //                                FirstName = "Stefan",
    //                                LastName = "Zeitlhofer"
    ...
    //            }
    //        });
    //        Assert.Equal("New Fancy Description", raceEntities.FirstOrDefault().Description);
    //    }
    }
}
