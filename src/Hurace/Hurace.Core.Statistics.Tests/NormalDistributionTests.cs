...
namespace Hurace.Core.Statistics.Tests
{
    public class NormalDistributionTests
    {
        ...
        [Fact]
        public void DenormalizeValueTest1()
        {
            ...
            var actualValue = NormalDistribution.DenormalizeValue(mean, stdDev, normalizedValue);

            Assert.Equal(expectedValue, actualValue);
        }

        [Fact]
        public void DenormalizeValueTest2()
        {
            var normalizedValue = 1;
            var expectedValue = 6.25;
